...
function App() {
  ...
  return (
    <div className="App bg-primary w-screen h-screen flex justify-start">
      <div className="top-0 left-0 z-40 w-64 h-screen" aria-label="Sidebar">
      ...
      <div className='w-1 h-screen bg-secondary'></div>
      {/* <p>Hello there</p>
      ...
      <div className='p-6'>
        <div className='text-white text-6xl uppercase font-bold mb-6'>Discover</div>
        {view()}
      </div>
    </div>
  );
