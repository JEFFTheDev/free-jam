...
using FreeJam.API.Repositories;
using FreeJam.API.Services;
...
builder.Services.AddDbContext<FreeJam.API.Data.ApplicationDbContext>(options =>
...
var db = scope.ServiceProvider.GetService<FreeJam.API.Data.ApplicationDbContext>();
if (db == null)
{
